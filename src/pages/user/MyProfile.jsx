...
const MyProfile = () => {
    ...
    const loadCourse = async () => {
        try {
            ...
            setCourses(res.data.chiTietKhoaHocGhiDanh);
            console.log(courses);
        } catch (error) {
            // Xử lý lỗi nếu có
              ...
              User Profile
                ...
                <div className="row gutters-sm">
                    <div className="col-md-4 mb-3">
                        <div className="card">
                            <div className="card-body " style={{ background: '#1eb2a6' }}>
                    ...
                    <div className="col-md-8">
                        <MDBTabs fill className="mb-3 fw-bold">
                            <MDBTabsItem>
                        ...
                        <MDBTabsContent>
                            ...
                            <MDBTabsPane open={fillActive === 'tab2'}>
                              <div className="row">
                                ...
                                <CourseTab course={courses}  user={userInfo} />
                              </div>
                            </MDBTabsPane>
                        </MDBTabsContent>
                    </div>
