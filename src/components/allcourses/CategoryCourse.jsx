...
const CategoryCourse = () => {
    ...
    const getCourseApi = async (page = 1) => {
        try {
            const res = await axios.get('https://elearningnew.cybersoft.edu.vn/api/QuanLyKhoaHoc/LayKhoaHocTheoDanhMuc', {
                params: {
                    maDanhMuc: maDanhMuc,
                    MaNhom: 'GP02',
                },
                    ...
                    <div className="grid grid-cols-3 gap-8 md:grid-cols-1">
                      ...
                      {item.danhMucKhoaHoc.maDanhMucKhoahoc}
                                ...
                                <div className="text p-3">
                                    ...
                                    <h3 className="text-black mt-4 font-medium h-8">{item.tenKhoaHoc}</h3>
                                    ...
                                    <div className="user flex items-center">
                                        ...
                                        />
                                        <span className="text-[14px] ml-2"> {item.nguoiTao.hoTen}</span>
                                    </div>
                                </div>
